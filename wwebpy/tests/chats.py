...
from wwebpy.chat.locators import ChatLocators  # TODO: this ref should not be coupled with another page
from wwebpy.chats.pages import PanePage
from wwebpy.tests.base import LoggedInTestCase
...
class PanePageTests(LoggedInTestCase):
    ...
    def test_can_detect_first_opened_chat_with_new_messages_and_send_a_message(self):
        ...
        chat_text_field.send_keys("Hi, I am wwebpy: Libary WhatsApp ChatBot! By Kaze")
