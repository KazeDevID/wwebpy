...
# Thanks to Fantoso fix in My wwebpy
#######################################################
import datetime
import time
import unittest
...
from wwebpy.pages import safe_path
from wwebpy.tests.base import LoggedInTestCase, FileBaseTestCase


class ChatPageTests(FileBaseTestCase):
    driver = None
    file_path = "/home/KazeDevID/github/el_wwebpy/wwebpy/tests/html/rastri_chat_template_full.html"
    ...
    def test_can_check_contact_chat_status_and_contact_info(self):
        ...
        icon_file = "file:///home/KazeDevID/github/el_wwebpy/wwebpy/tests/html/rastri_chat_template_full_files/pp.jpeg"
    ...
    def test_can_read_five_most_recent_messages(self):
        ...
        my_msg = msgs[4]
        self.assertEqual(my_msg.text, "Crazy dick.. 4 were deleted send 4 more there.")
    ...
    def test_can_read_oldest_message(self):
        ...
        self.assertEqual(msg.text, "baby still in vzla?")
        self.assertIsNone(msg.status)  # this message does not have arrow status
    ...
    def test_can_read_five_oldest_messages(self):
        ...
        contact_msg = msgs[0]
        self.assertEqual(contact_msg.text, "baby still in vzla?")
        ...
        contact_msg = msgs[1]
        self.assertEqual(contact_msg.text, "My love")
    ...
    def test_can_get_all_messages_at_once(self):
        ...
        self.assertEqual(oldest_msg.text, "baby still in vzla?")
    ...
    def test_can_read_most_recent_message_from_myself(self):
        ...
        self.assertEqual(msg.contact, "CmrH")
        self.assertEqual(msg.text, "Crazy dick.. 4 were deleted send 4 more there.")
    ...
    def test_can_read_all_msgs_order_by_oldest_from_myself(self):
        ...
        self.assertEqual(oldest.text, "My love")
        ...
        self.assertEqual(ninth.text, "If it's empty...")
...
class InteractiveBaseTestCase(LoggedInTestCase):
    WAIT_TIME = 2
    OPENED_CHAT_CONTACT_NAME = "+62 822-2175-90187"
